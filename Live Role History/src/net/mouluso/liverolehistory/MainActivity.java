...
public class MainActivity extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if(DatabaseOperations.getInstance(getApplicationContext()).getHistoryList().size() == 0){
        	DatabaseOperations.getInstance(getApplicationContext()).insertHistory("O Alemán resacoso.",
    				"Axuda a un turista alemán a recupera-las súas cousas namentres disfruta de A Coruña.", 
    				"beer_icon");
    		DatabaseOperations.getInstance(getApplicationContext()).insertHistory("O Pelegrín", 
